...
import sys, os, re, subprocess, platform, shutil
...
class UpdateWorker(QThread):
    ...
    def run(self):
        try:
            ...
            temp_file = temp_dir / "yt_mp3_converter_update.exe"
            backup_file = temp_dir / "yt_mp3_converter_backup.exe"
...
class UpdateDialog(QDialog):
    ...
    def _start_update(self):
        ...
        self._worker = UpdateWorker(self.update_info['download_url'])
...
class App(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.worker  = None
        self.out_dir = str(Path.home() / "Downloads" / "YT-MP3")
